...
<?php
if(isset($_POST['F_Name']) && isset($_POST['L_Name']) &&isset($_POST['Email_ID']) &&isset($_POST['Password']) && isset($_POST['confirm_Pass']) && isset($_POST['year']) && isset($_POST['type_car']) && isset($_POST['model_car']) && isset($_POST['Phone']))
{
	$F_Name = $_POST['F_Name'];
	$L_Name = $_POST['L_Name'];
	...
	location.href ='/project_(3)/Login.php';
	</script>";
}else
{
	echo $stmt->error;
